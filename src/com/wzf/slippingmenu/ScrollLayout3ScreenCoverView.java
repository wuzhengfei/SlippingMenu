 ...
 * author     :  wuzhengfei
 */
public class ScrollLayout3ScreenCoverView extends LinearLayout {
	private static final String TAG = ScrollLayout3ScreenCoverView.class.getSimpleName() ;
	...
	public ScrollLayout3ScreenCoverView(Context context) {
		super(context);
		initView(context);
	}

	public ScrollLayout3ScreenCoverView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
...
//			scrollBy((int) distanceX, 0) ;
			Log.i(TAG, "onScroll  distanceX="+distanceX +"    dx="+dx);
			return true;
		}
