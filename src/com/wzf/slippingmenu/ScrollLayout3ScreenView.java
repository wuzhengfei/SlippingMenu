 ...
 * author     :  wuzhengfei
 */
public class ScrollLayout3ScreenView extends LinearLayout {
	private static final String TAG = ScrollLayout3ScreenView.class.getSimpleName() ;
	...
	public ScrollLayout3ScreenView(Context context) {
		super(context);
		initView(context);
	}

	public ScrollLayout3ScreenView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void snapToDestination(){
		...
		if( fling ){
			...
			if ( scrollX  < ( screenWidth - coverWidth )/2 + coverWidth) {
				scrollToScreen(LEFT_SCREEN, true);
			}else if( scrollX  < ( screenWidth + (screenWidth - coverWidth)/2) ){
